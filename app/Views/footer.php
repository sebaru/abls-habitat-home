...
<footer class="d-none d-md-block page-footer mt-2 fixed-bottom bg-transparent"> <!-- fixed-bottom-->
  ...
  <div class="row justifiy-content-end mt-2 fixed-bottom p-1">
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/hls.js/1.5.17/hls.min.js" integrity="sha512-wM1chFMmhx3kNMkiMOxOXFDMYzjN5I+w/fB4gCWyHQvJNS77IRByWMpKGMuq/HIfYIojWEafOrgxa5TDE39OA==" crossorigin="anonymous"></script>
